...
const BigText = ({ slice }: BigTextProps): JSX.Element => {
  return (
    <section
      ...
      className="min-h-screen w-screen overflow-hidden bg-[#4169E1] text-[#FFD700] px-4" // added horizontal padding
    >
      ...
      <div className="grid justify-center gap-[3vw] text-[44vw] text-center md:flex md:text-[11vw]">
